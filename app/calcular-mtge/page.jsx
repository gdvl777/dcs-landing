      ...
      <main style={styles.page}>
        <div style={styles.container}>
          ...
          <section style={styles.card}>
            <div style={styles.cardTitle}>Según la resolución No. <a href="https://spdp.gob.ec/r52026/" target="_blank" rel="noopener noreferrer">SPDP-SPD-2026-0005-R </a> (resumen operativo)</div>
